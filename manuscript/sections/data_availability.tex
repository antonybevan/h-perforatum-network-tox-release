...
All processed data supporting this study (the committed liver-interactome networks, the curated target and DILI gene sets, and the computed result tables, with SHA-256 checksums in \path{data/CHECKSUMS.sha256}) are openly available in the project repository and in the archived Zenodo snapshot (see Code Availability):
