...
\noindent\footnotesize All values above are regenerated by the committed pipeline and reviewer-evidence scripts; cross-document numerical consistency is enforced by \path{verify_numbers.py}.
