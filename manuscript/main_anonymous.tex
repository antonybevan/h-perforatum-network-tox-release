% ============================================================================
% main_anonymous.tex  --  REVISED manuscript, DOUBLE-BLIND (anonymized) build
% Author/affiliation/email and repository URLs redacted for double-blind review.
% ============================================================================
\pdfminorversion=7
...
\usepackage{mathptmx}
\usepackage{microtype}              % professional kerning / justification
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize\itshape Separating effect size from statistical evidence}
...
\title{\textbf{Separating effect size from statistical evidence in network-proximity rankings under target-count asymmetry: a controlled liver-interactome audit}}

\author{
  \textit{Author name and affiliation removed for double-blind peer review} \\[1em]
}
\date{}
\newcommand{\suppauthor}{\textit{Author removed for double-blind review}}
...
\input{sections/code_availability_anonymous}
